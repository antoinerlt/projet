	...
	<main class="compte-prof">
	  ...
	  <article class="compte">
	  		<div class="block-head">
	  			...
	  			<a href="connexion-eleve.html" class="btn btn-primary btn-eleve-interaction">Rejoindre une session</a>
	  		</div>
	  		<div class="block-compte">
		  		<div class="col-md-offset-5 col-md-5">
		  			<img src="image/eleve.svg" alt="image eleve" class="image-profil-eleve">
		  		</div>
				...
				<div class="form-group">
	  				...
	  				<div class="col-md-4">
	    					<button id="modifier" name="modifier" class="btn btn-primary">Modifier</button>
	  				</div>
				</div>
	  		</div>
	  </article>
